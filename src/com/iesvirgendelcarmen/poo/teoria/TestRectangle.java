...
public class TestRectangle {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Average areas is %.2f%n", getAverageArrayList(rectangleList));
		
		System.out.println("The biggest rectangle is " + getBiggerArea(rectangleList));
	}
	...
	public static double getAverageArrayList(ArrayList<Rectangle> rectangleList) {
		double sum = 0;
	...
	public static String getBiggerArea(ArrayList<Rectangle> rectangleList) {
		
		int area = 0;
		Rectangle rectangleMayor = new Rectangle();
		for (Rectangle rectangle : rectangleList) {
			if(rectangle.getArea() > area) {
				area = rectangle.getArea();
				rectangleMayor = rectangle;
			}
			
		}
		
		return rectangleMayor.toString(); 
	}
	}
